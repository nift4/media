...
public class DefaultRenderersFactory implements RenderersFactory {
   ...
   */
  @CanIgnoreReturnValue
  public final DefaultRenderersFactory setPcmEncodingRestrictionLifted(boolean pcmEncodingRestrictionLifted) {
  ...
  public Renderer[] createRenderers(
    ...
    @Nullable
    AudioSink audioSink =
        buildAudioSink(context, pcmEncodingRestrictionLifted, enableFloatOutput, enableAudioTrackPlaybackParams);
    if (audioSink != null) {
      buildAudioRenderers(
          context,
          extensionRendererMode,
  ...
  protected AudioSink buildAudioSink(
      Context context, boolean pcmEncodingRestrictionLifted, boolean enableFloatOutput,
      boolean enableAudioTrackPlaybackParams) {
    ...
    return builder.setEnableAudioTrackPlaybackParams(enableAudioTrackPlaybackParams)
        .build();
  }
